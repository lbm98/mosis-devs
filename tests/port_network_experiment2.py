...
class PortNetworkExperiment2(CoupledDEVS):
    """
    ...
    def __init__(self, name: str):
        ...
        hundred_vessels = []
        for i in range(100):
            vessel_ctor = random.choices(vessels.ALL_VESSELS, vessels.VESSEL_WEIGHTS)[0]
            vessel = vessel_ctor(
                uid=i+amount_to_generate,
                # Important addition
                creation_time=0
            )
        ...
        self.dock_2 = self.addSubModel(Dock('2', hundred_vessels[13:25]))
        self.dock_3 = self.addSubModel(Dock('3', hundred_vessels[25:37]))
        self.dock_4 = self.addSubModel(Dock('4', hundred_vessels[37:50]))
        self.dock_5 = self.addSubModel(Dock('5', hundred_vessels[50:63]))
        self.dock_6 = self.addSubModel(Dock('6', hundred_vessels[63:75]))
        self.dock_7 = self.addSubModel(Dock('7', hundred_vessels[75:87]))
        self.dock_8 = self.addSubModel(Dock('8', hundred_vessels[87:100]))
...
def test1():
    system = PortNetworkExperiment2(name="system")
